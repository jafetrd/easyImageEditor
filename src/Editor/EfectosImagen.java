...
public class EfectosImagen {
       ...
       public static BufferedImage girarHorizontal(BufferedImage image) {
	...
	public static BufferedImage girarVertical(BufferedImage image) {
		BufferedImage processedImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_INT_ARGB);
	...
	public static BufferedImage girarVerticalHorizontal(BufferedImage image) {
		BufferedImage processedImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_INT_ARGB);
		// Flip vertical and horizontal
		for (int x = 0; x < image.getWidth(); x++) {
			for (int y = 0; y < image.getHeight(); y++) {
	...
	public static BufferedImage solarizar(BufferedImage image) {
		BufferedImage processedImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_INT_ARGB);
		for (int x = 0; x < image.getWidth(); x++) {
			for (int y = 0; y < image.getHeight(); y++) {
				int currentPixel = image.getRGB(x, y);
	...
	public static BufferedImage posterizar(BufferedImage image) {
		BufferedImage processedImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_INT_ARGB);
		for (int x = 0; x < image.getWidth(); x++) {
			for (int y = 0; y < image.getHeight(); y++) {
				int currentPixel = image.getRGB(x, y);
	...
	public static BufferedImage escalaGrises(BufferedImage image) {
		/*32 bits - >
	...
	public static BufferedImage invertir(BufferedImage image) {
		BufferedImage processedImage = new BufferedImage(image.getWidth(), image.getHeight(), BufferedImage.TYPE_INT_ARGB);
